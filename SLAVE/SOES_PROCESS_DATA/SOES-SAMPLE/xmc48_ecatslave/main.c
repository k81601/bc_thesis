...
#define GPIO_BUTTON2   P15_12


#define GPIO_LED1		P1_14
#define GPIO_LED2		P0_14
#define GPIO_LED3		P3_14


static const XMC_GPIO_CONFIG_t gpio_config_btn1 = {
  .mode = XMC_GPIO_MODE_INPUT_INVERTED_PULL_UP,
  .output_level = 0,
  .output_strength = 0
};
static const XMC_GPIO_CONFIG_t gpio_config_btn2 = {
  .mode = XMC_GPIO_MODE_INPUT_INVERTED_PULL_UP,
  .output_level = 0,
  .output_strength = 0
};
...
static const XMC_GPIO_CONFIG_t gpio_config_led3 = {
  .mode = XMC_GPIO_MODE_OUTPUT_PUSH_PULL,
  .output_level = XMC_GPIO_OUTPUT_LEVEL_LOW,
  .output_strength = XMC_GPIO_OUTPUT_STRENGTH_STRONG_SOFT_EDGE
};
