...
int main(void)
{
  ...
  XMC_GPIO_SetOutputLevel(P_LED1, XMC_GPIO_OUTPUT_LEVEL_HIGH);
  XMC_GPIO_SetOutputLevel(P_LED2, XMC_GPIO_OUTPUT_LEVEL_LOW);
  XMC_GPIO_SetOutputLevel(P_LED3, XMC_GPIO_OUTPUT_LEVEL_LOW);
  XMC_GPIO_SetOutputLevel(P_LED4, XMC_GPIO_OUTPUT_LEVEL_HIGH);
  XMC_GPIO_SetOutputLevel(P_LED5, XMC_GPIO_OUTPUT_LEVEL_HIGH);
  XMC_GPIO_SetOutputLevel(P_LED6, XMC_GPIO_OUTPUT_LEVEL_HIGH);
  XMC_GPIO_SetOutputLevel(P_LED7, XMC_GPIO_OUTPUT_LEVEL_HIGH);
  XMC_GPIO_SetOutputLevel(P_LED8, XMC_GPIO_OUTPUT_LEVEL_HIGH);
