...
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }, /* Subindex5 - IN_GEN_Bit1 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }, /* Subindex6 - IN_GEN_Bit2 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }, /* Subindex7 - IN_GEN_Bit3 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }, /* Subindex8 - IN_GEN_Bit4 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }, /* Subindex9 - IN_GEN_Bit5 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }, /* Subindex10 - IN_GEN_Bit6 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }, /* Subindex11 - IN_GEN_Bit7 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READ }}; /* Subindex12 - IN_GEN_Bit8 */
...
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }, /* Subindex5 - OUT_GEN_Bit1 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }, /* Subindex6 - OUT_GEN_Bit2 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }, /* Subindex7 - OUT_GEN_Bit3 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }, /* Subindex8 - OUT_GEN_Bit4 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }, /* Subindex9 - OUT_GEN_Bit5 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }, /* Subindex10 - OUT_GEN_Bit6 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }, /* Subindex11 - OUT_GEN_Bit7 */
{ DEFTYPE_BOOLEAN , 0x1 , ACCESS_READWRITE }}; /* Subindex12 - OUT_GEN_Bit8 */
